...
enum LID_TYPE
{
    AVIA = 1, VELO16, OUST64, HESAIxt32, RS16
}; //{1, 2, 3, 4, 5}
enum TIME_UNIT
{
...
//   EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    ...
    void process(const livox_ros_driver::msg::CustomMsg& msg, PointCloudXYZI::Ptr& pcl_out);
...
private:
    void avia_handler(const livox_ros_driver::msg::CustomMsg& msg);
